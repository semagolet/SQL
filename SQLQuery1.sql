...
CREATE CLUSTRED INDEX IndexName ON TableName 

/* INDEX REBUILD */

ALTER INDEX ALL ON TABLE_NAME REBUILD

/* TEK BİR INDEC REBUILD ETME */

ALTER INDEX INDEX_NAME ON INDEX_NAME REBUILD

/* TABLODAKİ TEK BİR INDEXİ REORGANIZE ETME */

ALTER INDEC INDEX_NAME ON SALES.INDEX_NAME REORGANIZE 
